...
- GPU-accelerated homology search with MMseqs2
  ...
  <div class="modal" id="modal-GPU-accelerated homology search with MMseqs2">
    <div class="modal-content">
      <span class="close-modal" data-cite="GPU-accelerated homology search with MMseqs2">&times;</span>
      <pre>@article{kallenborn2025gpu,
...
- MotifBench: A standardized protein design benchmark for motif-scaffolding problems
  ...
  <div class="modal" id="modal-MotifBench: A standardized protein design benchmark for motif-scaffolding problems">
    <div class="modal-content">
      <span class="close-modal" data-cite="MotifBench: A standardized protein design benchmark for motif-scaffolding problems">&times;</span>
      <pre>@article{zheng2025motifbench,
  title={MotifBench: A standardized protein design benchmark for motif-scaffolding problems},
  author={Zheng, Zhuoqi and Zhang, Bo and Didi, Kieran and Yang, Kevin K and Watson, Joseph L and Chen, Hai-Feng and Trippe, Brian L},
  journal={arxiv},
  year={2025}
}</pre>
    </div>
...
- BioNeMo Framework: a modular, high-performance library for AI model development in drug discovery
  ...
  <div class="modal" id="modal-BioNeMo Framework: a modular, high-performance library for AI model development in drug discovery">
    <div class="modal-content">
      <span class="close-modal" data-cite="BioNeMo Framework: a modular, high-performance library for AI model development in drug discovery">&times;</span>
      <pre>@article{stjohn2024bionemo,
  title={BioNeMo Framework: a modular, high-performance library for AI model development in drug discovery},
  author={St. John, Peter and ...},
  journal={arxiv},
  year={2024}
}</pre>
    </div>
...
- BioModelsML: Building a FAIR and reproducible collection of machine learning models in life sciences and medicine for easy reuse
  ...
  <div class="modal" id="modal-BioModelsML: Building a FAIR and reproducible collection of machine learning models in life sciences and medicine for easy reuse">
    <div class="modal-content">
      <span class="close-modal" data-cite="BioModelsML: Building a FAIR and reproducible collection of machine learning models in life sciences and medicine for easy reuse">&times;</span>
      <pre>@article{tiwari2023biomodelsml,
  ...
  author={Tiwari, Divyang Deep and Hoffmann, Nils and Didi, Kieran and Deshpande, Sumukh and Ghosh, Sucheta and Nguyen, Tung V. N. and Raman, Karthik and Hermjakob, Henning and Sheriff, Rahuman S. and Malik, ...},
  journal={biorxviv},
  year={2023}
}</pre>
    </div>
...
- Structure-based Drug Design with Equivariant Diffusion Models
  ...
  <div class="modal" id="modal-Structure-based Drug Design with Equivariant Diffusion Models">
    <div class="modal-content">
      <span class="close-modal" data-cite="Structure-based Drug Design with Equivariant Diffusion Models">&times;</span>
      <pre>@article{schneuing2024structure,
  title={Structure-based Drug Design with Equivariant Diffusion Models},
  author={Schneuing, Arne and Du, Yuanqi and Harris, Charles and Didi, Kieran and Jamasb, Arian and Igashov, Ilia and Du, weitao and Blundell, Tom and Liò, Pietro and Gomes, Carla and Welling, Max and Bronstein, Michael and Correia, Bruno},
...
- MISATO: machine learning dataset of protein–ligand complexes for structure-based drug discovery
  ...
  <div class="modal" id="modal-MISATO: machine learning dataset of protein–ligand complexes for structure-based drug discovery">
    <div class="modal-content">
      <span class="close-modal" data-cite="MISATO: machine learning dataset of protein–ligand complexes for structure-based drug discovery">&times;</span>
      <pre>@article{siebenmorgen2024misato,
  title={MISATO: machine learning dataset of protein–ligand complexes for structure-based drug discovery},
  author={Siebenmorgen, Till and Menezes, Filipe and Benassou, Sabrina and Merdivan, Erinc and Didi, Kieran and Mourão, André Santos Dias and Kitel, Radosław and Liò, Pietro and Kesselheim, Stefan and Piraud, Marie and Theis, Fabian J and Sattler, Michael and Popowicz, Grzegorz M},
  journal={Nature Computational Science},
  year={2024}
}</pre>
    </div>
...
- Synsor: a tool for alignment-free detection of engineered DNA sequences
  ...
  <div class="modal" id="modal-Synsor: a tool for alignment-free detection of engineered DNA sequences">
    <div class="modal-content">
      <span class="close-modal" data-cite="Synsor: a tool for alignment-free detection of engineered DNA sequences">&times;</span>
      <pre>@article{tay2024synsor,
  title={Synsor: a tool for alignment-free detection of engineered DNA sequences},
  author={Tay, Aidan P and Didi, Kieran and Wickramarachchi, Anuradha and Bauer, Denis and Wilson, Laurence and Maselko, Maciej},
...
- AbNatiV: VQ-VAE-based assessment of antibody and nanobody nativeness for hit selection, humanisation, and engineering
  ...
  <div class="modal" id="modal-AbNatiV: VQ-VAE-based assessment of antibody and nanobody nativeness for hit selection, humanisation, and engineering">
    <div class="modal-content">
      <span class="close-modal" data-cite="AbNatiV: VQ-VAE-based assessment of antibody and nanobody nativeness for hit selection, humanisation, and engineering">&times;</span>
      <pre>@article{ramon2023abnativ,
...
- Biomolecular condensate phase diagrams with a combinatorial microdroplet platform
  ...
  <div class="modal" id="modal-Biomolecular condensate phase diagrams with a combinatorial microdroplet platform">
    <div class="modal-content">
      <span class="close-modal" data-cite="Biomolecular condensate phase diagrams with a combinatorial microdroplet platform">&times;</span>
      <pre>@article{arter2022biomolecular,
  title={Biomolecular condensate phase diagrams with a combinatorial microdroplet platform},
  author={Arter, William E and Qi, Runzhang and Erkamp, Nadia A and Krainer, Georg and Didi, Kieran and Welsh, Timothy J and Acker, Julia and Nixon-Abell, Jonathan and Qamar, Seema and Guillén-Boixet, Jordina and Franzmann, Titus M and Kuster, David and Hyman, Anthony A and Borodavka, Alexander and St George-Hyslop, Peter and Alberti, Simon and Knowles, Tuomas P J},
...
- [Compositional Flows for 3D Molecule and Synthesis Pathway Co-design](https://arxiv.org/abs/2504.08051), Tony Shen\*, Seonghwan Seo\*, Ross Irwin, **Kieran Didi**, Simon Olsson, Woo Youn Kim, Martin Ester, **ICML 2025**
  <div class="publication-buttons">
    ...
    <button class="pub-button cite-btn" data-cite="Compositional Flows for 3D Molecule and Synthesis Pathway Co-design">📑 Cite</button>
  </div>
  <div class="modal" id="modal-Compositional Flows for 3D Molecule and Synthesis Pathway Co-design">
    <div class="modal-content">
      <span class="close-modal" data-cite="Compositional Flows for 3D Molecule and Synthesis Pathway Co-design">&times;</span>
      <pre>@article{shen2025compositional,
...
- [Proteina: Scaling Flow-based Protein Structure Generative Models](https://arxiv.org/abs/2503.00710), Tomas Geffner\*, **Kieran Didi**\*, Zuobai Zhang\*, Danny Reidenbach, Zhonglin Cao, Jason Yim, Mario Geiger, Christian Dallago, Emine Kucukbenli, Arash Vahdat, Karsten Kreis, **ICLR 2025 (oral presentation)**
  <div class="publication-buttons">
    ...
    <button class="pub-button cite-btn" data-cite="Proteina: Scaling Flow-based Protein Structure Generative Models">📑 Cite</button>
  </div>
  <div class="modal" id="modal-Proteina: Scaling Flow-based Protein Structure Generative Models">
    <div class="modal-content">
      <span class="close-modal" data-cite="Proteina: Scaling Flow-based Protein Structure Generative Models">&times;</span>
      <pre>@article{geffner2025proteina,
...
- [DEFT: Efficient Finetuning of Conditional Diffusion Models by Learning the Generalised h-transform](https://arxiv.org/abs/2406.01781), Alexander Denker\*, Francisco Vargas\*, Shreyas Padhy\*, **Kieran Didi**\*, Simon Mathis\*, Vincent Dutordoir, Riccardo Barbano, Emile Mathieu, Urszula Julia Komorowska, Pietro Lio, **NeurIPS 2024**
  <div class="publication-buttons">
    ...
    <button class="pub-button cite-btn" data-cite="DEFT: Efficient Finetuning of Conditional Diffusion Models by Learning the Generalised h-transform">📑 Cite</button>
  </div>
  <div class="modal" id="modal-DEFT: Efficient Finetuning of Conditional Diffusion Models by Learning the Generalised h-transform">
    <div class="modal-content">
      <span class="close-modal" data-cite="DEFT: Efficient Finetuning of Conditional Diffusion Models by Learning the Generalised h-transform">&times;</span>
      <pre>@article{denker2024deft,
...
- [Dynamics-Informed Protein Design with Structure Conditioning](https://openreview.net/forum?id=jZPqf2G9Sw), Urszula Julia Komorowska\*, Simon V Mathis\*, **Kieran Didi**, Francisco Vargas, Pietro Lio, Mateja Jamnik , **ICLR 2024**
  <div class="publication-buttons">
    ...
    <button class="pub-button cite-btn" data-cite="Dynamics-Informed Protein Design with Structure Conditioning">📑 Cite</button>
  </div>
  <div class="modal" id="modal-Dynamics-Informed Protein Design with Structure Conditioning">
    <div class="modal-content">
      <span class="close-modal" data-cite="Dynamics-Informed Protein Design with Structure Conditioning">&times;</span>
      <pre>@article{komorowska2024dynamics,
...
- [Evaluating Representation Learning on the Protein Structure Universe](https://arxiv.org/abs/2406.13864), Arian Rokkum Jamasb\*, Alex Morehead\*, Zuobai Zhang\*, Chaitanya Joshi\*, **Kieran Didi**, Simon Mathis, Charles Harris, Jian Tang, Jianlin Cheng, Pietro Liò, Tom Blundell, **ICLR 2024**
  <div class="publication-buttons">
    ...
    <button class="pub-button cite-btn" data-cite="Evaluating Representation Learning on the Protein Structure Universe">📑 Cite</button>
  </div>
  <div class="modal" id="modal-Evaluating Representation Learning on the Protein Structure Universe">
    <div class="modal-content">
      <span class="close-modal" data-cite="Evaluating Representation Learning on the Protein Structure Universe">&times;</span>
      <pre>@article{jamasb2024evaluating,
...
- [RNA-FrameFlow: Flow Matching for de novo 3D RNA Backbone Design](https://arxiv.org/abs/2406.13839), Rishabh Anand\*, Chaitanya K. Joshi\*, Alex Morehead, Arian R. Jamasb, Charles Harris, Simon V. Mathis, **Kieran Didi**, Bryan Hooi, Pietro Liò, **ICML SPIGM 2024 (Oral Presentation)**, 07/2024
  <div class="publication-buttons">
    ...
    <button class="pub-button cite-btn" data-cite="RNA-FrameFlow: Flow Matching for de novo 3D RNA Backbone Design">📑 Cite</button>
  </div>
  <div class="modal" id="modal-RNA-FrameFlow: Flow Matching for de novo 3D RNA Backbone Design">
    <div class="modal-content">
      <span class="close-modal" data-cite="RNA-FrameFlow: Flow Matching for de novo 3D RNA Backbone Design">&times;</span>
      <pre>@article{anand2024rna,
...
- [A framework for conditional diffusion modelling with applications in motif scaffolding for protein design](https://arxiv.org/abs/2312.09236), **Kieran Didi***, Francisco Varga*, Simon Mathis*, Vincent Dutordoir*, Emile Mathieu, Urszula Julia Komorowska, Pietro Lio, **NeurIPS AI4D3 2023 (Oral Presentation)**, 11/2023
  <div class="publication-buttons">
    ...
    <button class="pub-button cite-btn" data-cite="A framework for conditional diffusion modelling with applications in motif scaffolding for protein design">📑 Cite</button>
  </div>
  <div class="modal" id="modal-A framework for conditional diffusion modelling with applications in motif scaffolding for protein design">
    <div class="modal-content">
      <span class="close-modal" data-cite="A framework for conditional diffusion modelling with applications in motif scaffolding for protein design">&times;</span>
      <pre>@article{didi2023framework,
...
- [Benchmarking Generated Poses: How Rational is Structure-based Drug Design with Generative Models?](https://arxiv.org/abs/2308.07413), Charles Harris, **Kieran Didi**, Arian Jamasb, Chaitanya Joshi, Simon Mathis, Pietro Lio, Tom Blundell, **NeurIPS MLSB 2023 (Oral Presentation)**, 11/2023
  <div class="publication-buttons">
    ...
    <button class="pub-button cite-btn" data-cite="Benchmarking Generated Poses: How Rational is Structure-based Drug Design with Generative Models?">📑 Cite</button>
  </div>
  <div class="modal" id="modal-Benchmarking Generated Poses: How Rational is Structure-based Drug Design with Generative Models?">
    <div class="modal-content">
      <span class="close-modal" data-cite="Benchmarking Generated Poses: How Rational is Structure-based Drug Design with Generative Models?">&times;</span>
      <pre>@article{harris2023benchmarking,
...
- Modelling biology in novel ways - an AI-first course in Structural Bioinformatics, **Kieran Didi**, Charles Harris, Pietro Liò, Rainer Beck, **NeurIPS AI4Science 2023**, 10/2023 
  <div class="publication-buttons">
    ...
    <button class="pub-button cite-btn" data-cite="Modelling biology in novel ways - an AI-first course in Structural Bioinformatics">📑 Cite</button>
  </div>
  <div class="modal" id="modal-Modelling biology in novel ways - an AI-first course in Structural Bioinformatics">
    <div class="modal-content">
      <span class="close-modal" data-cite="Modelling biology in novel ways - an AI-first course in Structural Bioinformatics">&times;</span>
      <pre>@article{didi2023modelling,
...
- [Flexible Small-Molecule Design and Optimization with Equivariant Diffusion Models](https://drive.google.com/file/d/11kSYs6WYAg2_D0HtF8NxG7e6dUGQcVaL/view), Charles Harris, **Kieran Didi**, Arne Schneuing, Yuanqi Du, Arian Jamasb, Michael Bronstein, Bruno Correia, Pietro Liò, Tom Blundell, **ICLR MLDD 2023**, 03/2023
  <div class="publication-buttons">
    ...
    <button class="pub-button cite-btn" data-cite="Flexible Small-Molecule Design and Optimization with Equivariant Diffusion Models">📑 Cite</button>
  </div>
  <div class="modal" id="modal-Flexible Small-Molecule Design and Optimization with Equivariant Diffusion Models">
    <div class="modal-content">
      <span class="close-modal" data-cite="Flexible Small-Molecule Design and Optimization with Equivariant Diffusion Models">&times;</span>
      <pre>@article{harris2023flexible,
...
- *Generative Models in Bioinformatics*, Mitchell J O'Brien, Letitia MF Sng, Priya Ramarao-Milne, **Kieran Didi**, Denis C Bauer, **Encyclopedia of Bioinformatics and Computational Biology**, 01/2023
  <div class="publication-buttons">
    <button class="pub-button cite-btn" data-cite="Generative Models in Bioinformatics">📑 Cite</button>
  </div>
  <div class="modal" id="modal-Generative Models in Bioinformatics">
    <div class="modal-content">
      <span class="close-modal" data-cite="Generative Models in Bioinformatics">&times;</span>
      <pre>@article{obrien2023generative,
  title={Generative Models in Bioinformatics},
  author={O'Brien, Mitchell J and Sng, Letitia MF and Ramarao-Milne, Priya and Didi, Kieran and Bauer, Denis C},
